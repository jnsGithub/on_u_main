    ...
    return Scaffold(
      ...
      body: Obx(() => ListView.separated(
          ...
          itemBuilder: (context, index) {
            DateFormat dateFormat = DateFormat.MMMMd('ko');
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('     ${controller.dateToString(controller.myReservationList[index].date)}', style: TextStyle(fontSize: 13, color: gray700, fontWeight: FontWeight.w400),),
                      SizedBox(height: 5,),
                      ListTile(
                        leading: CircleAvatar(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.network(controller.myReservationList[index].counselorPhotoUrl, width: 60, height: 60, fit: BoxFit.cover,),
                          ),
                        ),
                        title: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
